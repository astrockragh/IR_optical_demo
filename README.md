...
This repo contains a Jupyter Notebook that demonstrates how to **disprove the old paradigm** by using a **data-driven model** to predict **infrared photometry** from optical spectra with **excellentaccuracy** (we’re talking **\($\chi^2_N \approx 1\$)** for all WISE bands!).  
